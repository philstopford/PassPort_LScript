...
generatePassFrameScene: pass
{
		...
		if(chdir("CG"))
		{
			if(chdir("temp"))
			{
				...
				if(chdir("tempScenes"))
				{
					...
					newScenePath = outputFolder[1] + getsep() + "CG" + getsep() + "temp" + getsep() + "tempScenes" + getsep() + "testFrame_" + fileOutputPrefix + "_" + userOutputString + "_" + passNames[pass] + ".lws";
				}
				else
				{
					mkdir("tempScenes");
	...
	// Missing getsep after outputFolder[1] - Matt Gorner
	chdirString = outputFolder[1] + getsep() + "CG" + getsep() + "temp" + getsep();
	
	if(chdir(chdirString))
	{
		chdirString = "testFrame_" + fileOutputPrefix + "_" + userOutputString + "_" + passNames[pass];
		if(chdir(chdirString))
		{
			// Missing getsep after outputFolder[1] - Matt Gorner
			saveRGBImagesPrefix = outputFolder[1] + getsep() + "CG" + getsep() + "temp" + getsep() + "testFrame_" + fileOutputPrefix + "_" + userOutputString + "_" + passNames[pass] + getsep() + "testFrame_" + fileOutputPrefix + "_" + userOutputString + "_" + passNames[pass];
		}
		else
		{
			chdir("CG");
			chdir("temp");
			mkdir("testFrame_" + fileOutputPrefix + "_" + userOutputString + "_" + passNames[pass]);
			chdir("testFrame_" + fileOutputPrefix + "_" + userOutputString + "_" + passNames[pass]);
			// Missing getsep after outputFolder[1] - Matt Gorner
			saveRGBImagesPrefix = outputFolder[1] + getsep() + "CG" + getsep() + "temp" + getsep() + "testFrame_" + fileOutputPrefix + "_" + userOutputString + "_" + passNames[pass] + getsep() + "testFrame_" + fileOutputPrefix + "_" + userOutputString + "_" + passNames[pass];
		}
	}
								...
								if(bufferTestLineParse[4] == "LW_SpecialBuffers")
								{
									...
									if(line == "0")
									{
										...
										if(baseNameArray[size(baseNameArray)] != nil && baseNameArray[size(baseNameArray)] != "")
										{
											...
											updatedBufferSaverPath = "\"" + outputFolder[1] + "CG" + getsep() +"temp" + getsep() + "testFrame_" + fileOutputPrefix + "_" + userOutputString + "_" + passNames[pass] + getsep() + passNames[pass] + "_" + bufferBaseName;
											if(platformVar == 1 || platformVar == 10)
											{
								...
								if(bufferTestLineParse[4] == "LW_PSDExport")
								{
									...
									if(strleft(line,5) == "Path ")
									{
										...
										if(baseNameArray[size(baseNameArray)] != nil && baseNameArray[size(baseNameArray)] != "")
										{
											...
											updatedPsdSaverPath = "Path \"" + outputFolder[1] + "CG" + getsep() +"temp" + getsep() + "testFrame_" + fileOutputPrefix + "_" + userOutputString + "_" + passNames[pass] + getsep() + passNames[pass] + "_" + psdBaseName;
											if(platformVar == 1 || platformVar == 10)
											{
												noIntroPath = "\"" + outputFolder[1] + "CG" + getsep() +"temp" + getsep() + "testFrame_" + fileOutputPrefix + "_" + userOutputString + "_" + passNames[pass] + getsep() + passNames[pass] + "_" + psdBaseName;
								...
								if(bufferTestLineParse[4] == "LW_ExtendedRLAExport")
								{
									...
									if(strleft(line,1) != "")
									{
										...
										if(baseNameArray[size(baseNameArray)] != nil && baseNameArray[size(baseNameArray)] != "")
										{
											...
											updatedRlaSaverPath = outputFolder[1] + "CG" + getsep() +"temp" + getsep() + "testFrame_" + fileOutputPrefix + "_" + userOutputString + "_" + passNames[pass] + getsep() + passNames[pass] + "_" + rlaBaseName;
								...
								if(bufferTestLineParse[4] == "LW_ExtendedRPFExport")
								{
									...
									if(strleft(line,1) != "")
									{
										...
										if(baseNameArray[size(baseNameArray)] != nil && baseNameArray[size(baseNameArray)] != "")
										{
											...
											updatedRpfSaverPath = outputFolder[1] + "CG" + getsep() +"temp" + getsep() + "testFrame_" + fileOutputPrefix + "_" + userOutputString + "_" + passNames[pass] + getsep() + passNames[pass] + "_" + rpfBaseName;
								...
								if(bufferTestLineParse[4] == "Aura25Export")
								{
									...
									if(strleft(line,1) == "\"")
									{
										...
										if(baseNameArray[size(baseNameArray)] != nil && baseNameArray[size(baseNameArray)] != "")
										{
											...
											updatedAuraSaverPath = "\"" + outputFolder[1] + "CG" + getsep() +"temp" + getsep() + "testFrame_" + fileOutputPrefix + "_" + userOutputString + "_" + passNames[pass] + getsep() + passNames[pass] + "_" + auraBaseName;
								...
								if(bufferTestLineParse[4] == "iDof_channels_IF")
								{
									...
									if(strleft(line,1) != "")
									{
										...
										if(baseNameArray[size(baseNameArray)] != nil && baseNameArray[size(baseNameArray)] != "")
										{
											...
											updatedIdofSaverPath = outputFolder[1] + "CG" + getsep() +"temp" + getsep() + "testFrame_" + fileOutputPrefix + "_" + userOutputString + "_" + passNames[pass] + getsep() + passNames[pass] + "_" + idofBaseName;
...
} // generatePassFrameScene

generatePassSeqScene: pass
{
	// initial stuff
	overriddenObjectID = nil;
	overriddenObjectName = nil;
	...
	if(chdir(outputFolder[1]))
	{
		if(chdir("CG"))
		{
			if(chdir("temp"))
			{
				...
				if(chdir("tempScenes"))
				{
					newScenePath = outputFolder[1] + getsep() + "CG" + getsep() + "temp" + getsep() + "tempScenes" + getsep() + "seq_" + fileOutputPrefix + "_" + userOutputString + "_" + passNames[pass] + ".lws";
				}
				else
				{
					mkdir("tempScenes");
	...
	if(chdir(chdirString))
	{
		chdirString = "seq_" + fileOutputPrefix + "_" + userOutputString + "_" + passNames[pass];
		if(chdir(chdirString))
		{
			// Missing getsep after outputFolder[1] - Matt Gorner
			saveRGBImagesPrefix = outputFolder[1] + getsep() + "CG" + getsep() + "seq_" + fileOutputPrefix + "_" + userOutputString + "_" + passNames[pass] + getsep() + "seq_" + fileOutputPrefix + "_" + userOutputString + "_" + passNames[pass];
		}
		else
		{
			chdir("CG");
			mkdir("seq_" + fileOutputPrefix + "_" + userOutputString + "_" + passNames[pass]);
			chdir("seq_" + fileOutputPrefix + "_" + userOutputString + "_" + passNames[pass]);
	...
	{
		mkdir(outputFolder[1] + "CG" + getsep());
		chdir(outputFolder[1] + "CG" + getsep());
		mkdir("seq_" + fileOutputPrefix + "_" + userOutputString + "_" + passNames[pass]);
		chdir("seq_" + fileOutputPrefix + "_" + userOutputString + "_" + passNames[pass]);
	...
	seqOutputPath = saveRGBImagesPrefix;
							...
							// the stock render buffer exporter
								...
								if(bufferTestLineParse[4] == "LW_SpecialBuffers")
								{
									...
									if(line == "0")
									{
										...
										{
											bufferBaseName = baseNameArray[size(baseNameArray)];
											updatedBufferSaverPath = "\"" + outputFolder[1] + "CG" + getsep() + "seq_" + fileOutputPrefix + "_" + userOutputString + "_" + passNames[pass] + getsep() + passNames[pass] + "_" + bufferBaseName;
											if(platformVar == 1 || platformVar == 10)
											{
							...
							// the psd exporter
								if(bufferTestLineParse[4] == "LW_PSDExport")
								{
									...
									if(strleft(line,5) == "Path ")
									{
										...
										{
											psdBaseName = baseNameArray[size(baseNameArray)];
											updatedPsdSaverPath = "Path \"" + outputFolder[1] + "CG" + getsep() + "seq_" + fileOutputPrefix + "_" + userOutputString + "_" + passNames[pass] + getsep() + passNames[pass] + "_" + psdBaseName;
											if(platformVar == 1 || platformVar == 10)
											{
												noIntroPath = "\"" + outputFolder[1] + "CG" + getsep() + "seq_" + fileOutputPrefix + "_" + userOutputString + "_" + passNames[pass] + getsep() + passNames[pass] + "_" + psdBaseName;
												tempFixedPath = fixPathForWin32(noIntroPath);
												noIntroPath = tempFixedPath;
												newPathFixed = "Path " + noIntroPath;
							...
							// the rla exporter
								if(bufferTestLineParse[4] == "LW_ExtendedRLAExport")
								{
									...
									if(strleft(line,1) != "")
									{
										...
										{
											rlaBaseName = baseNameArray[size(baseNameArray)];
											updatedRlaSaverPath = outputFolder[1] + "CG" + getsep() + "seq_" + fileOutputPrefix + "_" + userOutputString + "_" + passNames[pass] + getsep() + passNames[pass] + "_" + rlaBaseName;
											toWrite = updatedRlaSaverPath;
										}
										else
										{
							...
							// the rpf exporter
								if(bufferTestLineParse[4] == "LW_ExtendedRPFExport")
								{
									...
									if(strleft(line,1) != "")
									{
										...
										{
											rpfBaseName = baseNameArray[size(baseNameArray)];
											updatedRpfSaverPath = outputFolder[1] + "CG" + getsep() + "seq_" + fileOutputPrefix + "_" + userOutputString + "_" + passNames[pass] + getsep() + passNames[pass] + "_" + rpfBaseName;
											toWrite = updatedRpfSaverPath;
										}
										else
										{
							...
							// the aura exporter
								if(bufferTestLineParse[4] == "Aura25Export")
								{
									...
									if(strleft(line,1) == "\"")
									{
										...
										{
											auraBaseName = baseNameArray[size(baseNameArray)];
											updatedAuraSaverPath = "\"" + outputFolder[1] + "CG" + getsep() + "seq_" + fileOutputPrefix + "_" + userOutputString + "_" + passNames[pass] + getsep() + passNames[pass] + "_" + auraBaseName;
											toWrite = updatedAuraSaverPath;
										}
										else
										{
							...
							// idof channels
								if(bufferTestLineParse[4] == "iDof_channels_IF")
								{
									...
									if(strleft(line,1) != "")
									{
										...
										{
											idofBaseName = baseNameArray[size(baseNameArray)];
											updatedIdofSaverPath = outputFolder[1] + "CG" + getsep() + "seq_" + fileOutputPrefix + "_" + userOutputString + "_" + passNames[pass] + getsep() + passNames[pass] + "_" + idofBaseName;
											toWrite = updatedIdofSaverPath;
										}
										else
										{
